...
namespace YA.Archive.MVC2.Controllers
{
    ...
    public class FileProjectController : Controller
    {
            ...
            , string sStartDate, string sEndDate, FormCollection form, bool sIsClickSearch)
        {
            ...
            {
                var oldS = (ReportClientFolderRRequest)TempData["oldSearchBackPF"];

                if (oldS != null)
                {
                    TempData["oldSearchBackPF"] = oldS;
...
,
            ...
            {
                TempData["oldSearchBackPF"] = new ReportClientFolderRRequest()
                {
                    RequsetCurrentUserId = System.Web.HttpContext.Current.User.Identity.GetUserId(),
